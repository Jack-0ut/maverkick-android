    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.checkAnswerEvent.observe(viewLifecycleOwner) { event ->
            event.getContentIfNotHandled()?.let { result ->
                ...
                if (result.first) {
                    snackbarView.setBackgroundColor(ContextCompat.getColor(requireContext(), com.maverkick.common.R.color.green))
                    snackbar.setText("Great job!")
                } else {
                    snackbarView.setBackgroundColor(ContextCompat.getColor(requireContext(), com.maverkick.common.R.color.red))

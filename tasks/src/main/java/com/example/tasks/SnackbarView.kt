...
class SnackbarView @JvmOverloads constructor(
    ...
    fun showCorrect(message: String) {
        setBackgroundColor(ContextCompat.getColor(context, com.example.common.R.color.green))
    ...
    fun showIncorrect(message: String) {
        setBackgroundColor(ContextCompat.getColor(context, com.example.common.R.color.red))

...
import com.maverkick.student.databinding.ItemCourseEnrolledBinding
...
class CourseAdapter(private val interactionListener: OnItemClickListener<Course>) :
    ...
    inner class CourseViewHolder(private val binding: ItemCourseEnrolledBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
        ...
        fun bind(course: Course) {
            ...
            when (course) {
                ...
                is PersonalizedTextCourse -> binding.icon.setImageResource(com.maverkick.common.R.drawable.ic_text_course)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CourseViewHolder {
        val binding = ItemCourseEnrolledBinding.inflate(LayoutInflater.from(parent.context), parent, false)
